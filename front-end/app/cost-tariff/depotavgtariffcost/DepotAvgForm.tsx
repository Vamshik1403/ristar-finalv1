        ...
        <form className="px-6 pb-6 pt-2" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-3 mt-8">
            <Button
              ...
              variant="outline"
              onClick={onClose}
              className="bg-neutral-800 text-white rounded hover:bg-neutral-700 border border-neutral-700 cursor-pointer"
            >
              Cancel
            </Button>
            <Button
              type="submit"
              className="bg-blue-700 text-white rounded hover:bg-blue-800 font-semibold cursor-pointer"
            >
