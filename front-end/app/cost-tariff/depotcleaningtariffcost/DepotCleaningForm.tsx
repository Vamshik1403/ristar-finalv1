        ...
        <form className="px-6 pb-6 pt-2" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center gap-3 mt-6">
            <Button
              ...
              variant="outline"
              onClick={onClose}
              className="bg-neutral-200 text-neutral-900 dark:bg-neutral-800 dark:text-white hover:bg-neutral-300 dark:hover:bg-neutral-700 border border-neutral-300 dark:border-neutral-700 cursor-pointer"
            >
              Cancel
            </Button>
            <Button
