...
const ExchangeRateTable = () => {
  ...
  return (
    <div className="px-4 pt-0 pb-4 min-h-screen bg-background">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mt-0 mb-4">
          <div className="relative w-full mr-4 max-w-xs">
            ...
            <input
              ...
              className="p-2 pl-10 rounded-lg bg-background text-foreground placeholder-muted-foreground border border-border focus:outline-none focus:border-blue-500"
              value={searchTerm}
        ...
        <div className="rounded-lg shadow border border-border bg-background overflow-x-auto min-h-[200px]">
          <Table className="bg-background min-h-[300px]">
            <TableHeader>
            ...
            <TableBody>
              {filteredRates.length === 0 ? (
                ...
                filteredRates.map((rate) => (
                  <TableRow key={rate.id} className="transition-colors hover:bg-muted border-b border-border">
                    <TableCell className="text-center text-foreground">{rate.fromCurrency?.currencyName} ({rate.fromCurrency?.currencyCode})</TableCell>
                    <TableCell className="text-center text-foreground">{rate.toCurrency?.currencyName} ({rate.toCurrency?.currencyCode})</TableCell>
                    ...
                    <TableCell className="text-center text-foreground">{new Date(rate.date).toLocaleDateString()}</TableCell>
                    <TableCell className="text-center">
                      <div className="flex justify-center gap-2">
                        <Button
                          ...
                          className="hover:bg-blue-100 hover:text-blue-700 text-muted-foreground transition-all duration-200 cursor-pointer"
                        >
                          <Pencil size={16} />
                        </Button>
                        <Button
                          ...
                          className="hover:bg-red-100 hover:text-red-700 text-muted-foreground transition-all duration-200 cursor-pointer"
                        >
                          <Trash2 size={16} />
                        </Button>
                      </div>
      ...
      <div className="bg-background">Test</div>
    </div>
